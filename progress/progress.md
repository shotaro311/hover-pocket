...
- push run [31759179183](https://github.com/shotaro311/hover-pocket/actions/runs/31759179183)とPR run [31759179663](https://github.com/shotaro311/hover-pocket/actions/runs/31759179663)で、Ubuntu / macOS / Windowsとcross-OS byte比較が成功した。PR #7はhead `5e9097c`、Ready、MERGEABLE。runtime source、Provider Registry、既存data format、requirements、PLAN1、承認画像は変更していない。詳細: `progress/2026-08/2026-08-14_hover-pocket-ai-native-an0-hardening.md`。
