...
- code head `8cd445b`はremote parity `0 / 0`である。PR同期時はRouter [33022367720](https://github.com/shotaro311/hover-pocket/actions/runs/33022367720)だけが自動起動し、通常の`pull_request` workflow runは作成されなかったため、同じexact headを手動dispatchした。macOS [33022481993](https://github.com/shotaro311/hover-pocket/actions/runs/33022481993)、Windows [33022484529](https://github.com/shotaro311/hover-pocket/actions/runs/33022484529)、3OS Pocket contract [33022486583](https://github.com/shotaro311/hover-pocket/actions/runs/33022486583)はすべて成功し、macOS logで新self-test、Windows全既存Verifier、3OS byte一致をreadbackした。
- Draft PR #39は`OPEN / MERGEABLE`、review / comment / unresolved thread 0件だが、requiredなPR checkとして自動runが結び付いていないため`mergeStateStatus=UNSTABLE`である。手動run成功をPR required-check成功へ読み替えず、自動check欠落を解消するまでReady / mergeへ進めない。
