...
- 正式署名済みMSI/helperの公開、通常Windows hostのUACとinstall / upgrade / rollback / uninstall、公開後readback、macOS正式配布は未完了。Draft PR #39はReady / mergeへ進めず、production setup / generation / activationをOFFで維持する。
