...
- 現在の公開ZIP成果物 `dist/releases/HoverPocket-0.1.0-63.zip` は Developer ID Application 署名と notarization/staple 済みで、GitHub Release `v0.1.0-63` に公開済み。latest appcast も build `63` を指す。一般ユーザー向けには同じ app-only payload を分かりやすい `HoverPocket-macOS-app.zip` として案内し、公開URLから再取得したZIPのトップレベルが `HoverPocket.app` のみであることを確認済み。SHA256 は `e99899a499ffce4d5fa5608706a10cecc23493fe14eaf5fa8c4fd466f64be15c`。
