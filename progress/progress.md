...
- 実SwiftUIの3か所の波形、ミュート斜線、停止表示をComputer Useで確認。入力音声はfixtureであり、実マイクでの発話と本番配信は未実施。インストール済み本番638は保持。
- 詳細: [実装・検証ログ](2026-09/2026-09-08_hover-pocket-voice-activity.md)。
