...
- Python release readback 19件、py_compile、shell構文、YAML、JavaScript、`git diff --check`が成功した。このMacにはPowerShell / .NET SDKがないためDraft PR CIを受入gateにする。詳細: `progress/2026-08/2026-08-24_hover-pocket-ai-native-an8-windows-signing.md`。
