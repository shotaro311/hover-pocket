...
- 現在の公開ZIP成果物 `dist/releases/HoverPocket-0.1.0-79.zip` は Developer ID Application 署名と notarization/staple 済みで、GitHub Release `v0.1.0-79` に公開済み。latest appcast も build `79` を指す。一般ユーザー向けには同じ app-only payload を分かりやすい `HoverPocket-macOS-app.zip` として案内し、公開URLから再取得したZIPのトップレベルが `HoverPocket.app` のみであることを確認済み。SHA256 は `37640b05fa518623b05482df1aec9fe549ee2df56eb62c650d84359b0ac57e89`。
