...
- 残る受入は、新headのWindows build / named-pipe verifier CI、通常Windows hostのelevated positive confinement、実モデルを使うauth control-plane / model-tool helper deny分離、credential非永続readback、Pocket App DSL生成からrollback、両OS物理Voice E2E、正式署名・配布である。
