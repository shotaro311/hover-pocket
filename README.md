...
macOSの修正版643を準備しています。音声の開始・終了は波形ボタン、ミュート切替はマイクボタンに分けました。閉じたノッチの左マイクでミュートを切り替え、右の波形で会話を終了できます。ミュート時の波形はグレーの点だけになり、Codex更新後の接続判定も再検査します。ローカル検証は完了し、本番配信を進めています。[変更・検証記録](progress/2026-09/2026-09-10_hover-pocket-voice-controls.md)。
