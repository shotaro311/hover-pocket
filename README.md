...
- Calendarパネルを開くと、本日の天気アイコンから週間予報へ順に一度だけ表示されます。本日のアイコンは、晴れ・曇り・雨雪に合うSF Symbols標準効果で約5秒だけ動きます。週間予報はアイコンの形にかかわらず曜日・アイコン・数値の各行が揃います。繰り返し再生せず、macOSの「視差効果を減らす」が有効な場合はアニメーションなしで即時表示します。
