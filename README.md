...
macOSの本番639では、会話中の波形、ミュートの斜線、ノッチ左右／ノッチなし画面の会話表示、音声による会話終了を追加し、試験機能Today Focusを削除しました。署名・Apple公証・公開ファイルの検証と、このMacの更新を完了しています。実マイクでの発話は未検証です。[実装・配信記録](progress/2026-09/2026-09-08_hover-pocket-voice-activity.md)。
